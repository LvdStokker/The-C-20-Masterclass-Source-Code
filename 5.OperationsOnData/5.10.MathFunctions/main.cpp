...
int main()
{
    ...
    // Luke
    // There is a log2() function but in general one can use log rules to calculate
    // for other bases say log3, log4, log5 etc where:
    // log_a_(b) = log_c_(b)/log_c_(a)
    // e.g. Logarithm with base 3
    double value = 9.0;
    double logBase3 = std::log(value) / std::log(3.0);
    std::cout << "Log base 3 of " << value << " is " << logBase3 << '\n';
